...
## 2. Configurações de Privacidade (tela Privacidade, dentro do Perfil)
...
* Se a opção "Bloquear" for escolhida para chamada de vídeo, ao tentar chamar aparece o aviso: "Esta opção está bloqueada".
* Quando alguém tenta acessar um perfil com bloqueio ativado, a tela aparece desenhada como perfil privado.
* Quando o perfil aceita o pedido de solicitação, ele fica aberto apenas para Conexões.

## 3. Bloqueio entre Usuários
